 ...
 * behavior.</strong>
 */
/* package */ class ThrioFlutterPageDelegate implements ExclusiveAppComponent<Activity> {
  ...
  @Nullable private            ThrioFlutterView  flutterView;
  ...
  View onCreateView(
    ...
    if (host.getRenderMode() == RenderMode.surface) {
      ...
      flutterView = new ThrioFlutterView(host.getContext(), flutterSurfaceView);
    } else {
      ...
      flutterView = new ThrioFlutterView(host.getContext(), flutterTextureView);
    }
    ...
    if (splashScreen != null) {
      ...
      ThrioFlutterSplashView flutterSplashView = new ThrioFlutterSplashView(host.getContext());
   ...
   */
  private void delayFirstAndroidViewDraw(final ThrioFlutterView flutterView) {
    if (host.getRenderMode() != RenderMode.surface) {
   ...
   *       delegate's {@link ThrioFlutterView}.
   * </ol>
   */
  void onStop() {
    Log.v(TAG, "onStop()");
  ...
  /* package */ interface Host
     ...
     * ThrioFlutterView.RenderMode} is set to {@link
     * ThrioFlutterView.RenderMode#surface}. Otherwise, {@link
     ...
     * <p>This method is only invoked if the {@link
     * ThrioFlutterView.RenderMode} is set to {@link
     * ThrioFlutterView.RenderMode#texture}. Otherwise, {@link
